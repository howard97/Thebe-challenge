...
<div class="app-content content">
                        ...
                        <div class="card">
                            <div class="card-header">
                                 <span style="font-size: 1.2em;">
                                    ...
                                    <strong>TUTOR MANAGEMENT MENU</strong>
                                    </span>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <p class="card-text">List Of tutors.</p>
                                       ...
                                       <c:forEach var="item" items="${devices}">
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <button type="button" class="btn btn-primary"><a href="editDevice?id=${item.id}"><i class="fa fa-edit"></i></a></button>
                                                <button type="button" id="deleteDevice" value="${item.id}" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>
                                            </th>
                                        </tr>
                                       </c:forEach>
                                        </tbody>--%>
    ...
    <script src="app-assets/js/tutorManagement/listOfTutors.js"></script>
